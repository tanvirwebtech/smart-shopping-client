        ...
        <div>
            <div className="container lg:py-10 py-6">
                <div className="feature-wrap">
                    <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 lg:gap-8 md:gap-6 gap-4">
                        <div className="single-ft flex justify-center sm:justify-start  items-center">
                            ...
                            <div className="ft-details ml-5">
                                <h4 className="lg:text-xl md:text-base  font-semibold">
                                    Free Shipping
                                </h4>
                                <span className="lg:text-xl md:text-base  font-light">
                                    Order $50 or more
                                </span>
                            </div>
                        </div>
